...
egoDist = TruncatedNormal(6, 2, 3, 8) # mean, stddev, low, high
actorDist = TruncatedNormal(2, 1, 1, 3) # start ego and actor at similar distances from intersection. actor closer.
