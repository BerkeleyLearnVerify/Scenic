...
path = localPath("data/logging_example2")

# Spawn car on that spot with logging autopilot behavior and
# - an RGB Camera pointing forward with specific attributes that should be recorded
# - an RGB Camera pointing backward
# - a semantic segmentation sensor with CityScapesPalette Conversion
ego = Car at spot,
    with behavior AutopilotBehavior(),
    with sensors {"front_camera": CarlaRGBSensor(offset=(1.6, 0, 1.7), attributes=attrs, record=path),
