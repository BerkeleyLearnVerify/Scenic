...
class ScenicParseError(ParseCompileError):
    """Error occuring the parsing of a Scenic program."""

    pass


class PythonCompileError(ParseCompileError):
    """Error occuring during the compilation of a Python program
    that is generated by translating a Scenic program."""
