...
param x = VerifaiRange(-1, 1)
param y = VerifaiRange(-1, 1)
...
# ego = new Car at (globalParameters.x, globalParameters.y, 0), with behavior DriveAvoidingCollisions(avoidance_threshold=5)
